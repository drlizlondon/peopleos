...
Migration is deliberately staged. V1-10 adds the Already-contacted default of 14. The chargeable MVP migration adds notification intent Off and reminder time 12:00, preserving every older preference. Backups through schema 4 receive those defaults; schema 5 also migrates forward, while current backup schema 6 requires the complete Settings shape including conversation starters.
